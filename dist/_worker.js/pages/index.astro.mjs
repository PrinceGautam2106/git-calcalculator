...
import { a as generateTitle, g as generateDescription, b as generateCanonical, d as combineSchemas, $ as $$BaseLayout, e as generateWebSiteSchema } from '../chunks/BaseLayout_ido6pgsy.mjs';
...
14 Free Calculators
</h2> <span class="inline-flex items-center justify-center w-6 h-6 rounded-sm bg-[var(--color-primary)] text-white text-xs font-bold" aria-hidden="true" data-astro-cid-j7pv25f6>14</span> </div> <p class="text-body-sm text-[var(--color-mute)]" data-astro-cid-j7pv25f6>
