...
const $$500 = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { "title": "Server Error \u2014 CalaiFitness", "description": "Something went wrong on our end.", "noindex": true }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="flex min-h-[80vh] items-center justify-center px-4 py-16"> <div class="max-w-xl text-center"> <!-- GitHub-style illustration --> <svg class="mx-auto mb-8 w-full max-w-sm opacity-90 dark:opacity-70" viewBox="0 0 400 300" fill="none" xmlns="http://www.w3.org/2000/svg"> <!-- Broken server/scale illustration --> <rect x="150" y="100" width="100" height="120" rx="8" fill="currentColor" class="text-black/10 dark:text-white/10"></rect> <rect x="170" y="120" width="60" height="40" rx="4" fill="currentColor" class="text-black/20 dark:text-white/20"></rect> <circle cx="200" cy="180" r="15" fill="currentColor" class="text-black/15 dark:text-white/15"></circle> <!-- Lightning bolt for error --> <path d="M210 60 L195 100 L210 100 L195 140 L230 100 L215 100 L230 60 Z" fill="currentColor" class="text-red-400/60"></path> <!-- 500 text --> <text x="200" y="260" font-size="42" font-weight="bold" fill="currentColor" class="text-red-400/80" text-anchor="middle">500</text> </svg> <h1 class="mb-3 text-3xl font-bold text-black dark:text-white">Server Error</h1> <p class="mb-8 text-base text-black/60 dark:text-white/60">
