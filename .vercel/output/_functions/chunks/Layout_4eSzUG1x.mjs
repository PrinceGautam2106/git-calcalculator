import { a as createComponent, m as maybeRenderHead, r as renderTemplate, d as renderComponent, c as createAstro, f as renderSlot, g as renderHead, b as addAttribute } from './astro/server_CCNkBnzp.mjs';
import 'kleur/colors';
import 'clsx';
/* empty css                         */
...
const $$Header = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<header class="sticky top-0 z-50 border-b border-black/10 bg-white/80 dark:border-white/10 dark:bg-black/80 backdrop-blur-xl" data-astro-cid-3ef6ksr2> <div class="mx-auto flex h-14 sm:h-16 max-w-7xl items-center justify-between px-3 sm:px-4 md:px-6" data-astro-cid-3ef6ksr2> <a href="/" class="flex items-center gap-2 sm:gap-3 min-w-0" data-astro-cid-3ef6ksr2> <img id="logo-light" src="/favicon.svg" alt="FitnessCalculator" class="h-7 sm:h-8 w-7 sm:w-8 flex-shrink-0 hidden dark:inline" data-astro-cid-3ef6ksr2> <img id="logo-dark" src="/favicon.svg" alt="FitnessCalculator" class="h-7 sm:h-8 w-7 sm:w-8 flex-shrink-0 dark:hidden" data-astro-cid-3ef6ksr2> <span class="hidden sm:inline text-sm font-medium text-black dark:text-white truncate" data-astro-cid-3ef6ksr2>FitnessCalculator</span> </a> <nav class="hidden items-center gap-4 sm:gap-8 md:flex" data-astro-cid-3ef6ksr2> <a href="/dashboard" id="nav-dashboard" class="text-xs sm:text-sm text-black/60 dark:text-white/60 transition-colors hover:text-black dark:hover:text-white whitespace-nowrap" data-astro-cid-3ef6ksr2>Dashboard</a> <a href="/calculators" id="nav-calculators" class="text-xs sm:text-sm text-black/60 dark:text-white/60 transition-colors hover:text-black dark:hover:text-white whitespace-nowrap" data-astro-cid-3ef6ksr2>Calculators</a> <a href="/history" id="nav-history" class="text-xs sm:text-sm text-black/60 dark:text-white/60 transition-colors hover:text-black dark:hover:text-white whitespace-nowrap" data-astro-cid-3ef6ksr2>History</a> </nav> <div class="flex items-center gap-2 sm:gap-4" data-astro-cid-3ef6ksr2> <div id="streak-badge" class="hidden flex items-center gap-2 rounded-full border border-black/10 bg-black/5 px-2 sm:px-3 py-1 sm:py-1.5 text-[10px] sm:text-xs font-medium text-black/60 dark:border-white/10 dark:bg-white/5 dark:text-white/60 flex-shrink-0" data-astro-cid-3ef6ksr2> <span data-astro-cid-3ef6ksr2>🔥</span> <span id="streak-text" data-astro-cid-3ef6ksr2>0 day streak</span> </div> ${renderComponent($$result, "ThemeToggle", $$ThemeToggle, { "data-astro-cid-3ef6ksr2": true })} <!-- Mobile Menu Button --> <button id="mobile-menu-btn" class="md:hidden text-xl text-black dark:text-white hover:opacity-70 transition" data-astro-cid-3ef6ksr2> <span data-astro-cid-3ef6ksr2>☰</span> </button> </div> </div> <!-- Mobile Menu Dropdown --> <div id="mobile-menu" class="hidden md:hidden border-t border-black/10 dark:border-white/10 bg-white/95 dark:bg-black/95 backdrop-blur" data-astro-cid-3ef6ksr2> <div class="mx-auto max-w-7xl px-3 sm:px-4 md:px-6 py-2" data-astro-cid-3ef6ksr2> <div class="grid grid-cols-3 gap-2" data-astro-cid-3ef6ksr2> <a href="/dashboard" class="flex flex-col items-center gap-1.5 py-3 px-2 rounded-lg hover:bg-black/5 dark:hover:bg-white/5 transition text-black dark:text-white" data-astro-cid-3ef6ksr2> <span class="text-2xl" data-astro-cid-3ef6ksr2>📊</span> <span class="text-xs font-medium" data-astro-cid-3ef6ksr2>Dashboard</span> </a> <a href="/calculators" class="flex flex-col items-center gap-1.5 py-3 px-2 rounded-lg hover:bg-black/5 dark:hover:bg-white/5 transition text-black dark:text-white" data-astro-cid-3ef6ksr2> <span class="text-2xl" data-astro-cid-3ef6ksr2>🧮</span> <span class="text-xs font-medium" data-astro-cid-3ef6ksr2>Calculators</span> </a> <a href="/history" class="flex flex-col items-center gap-1.5 py-3 px-2 rounded-lg hover:bg-black/5 dark:hover:bg-white/5 transition text-black dark:text-white" data-astro-cid-3ef6ksr2> <span class="text-2xl" data-astro-cid-3ef6ksr2>📜</span> <span class="text-xs font-medium" data-astro-cid-3ef6ksr2>History</span> </a> </div> </div> </div> </header>  `;
